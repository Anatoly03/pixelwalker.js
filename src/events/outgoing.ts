 ...
 * | Index | Type | Description |
 * | --- | --- | --- |
 * | 0 | `Buffer` | Block positions |
 * | 1 | `number` | Layer |
 * | 2 | `number` | Block ID |
 * | ... | `any` | Additional Block Data |
 */
export const WorldBlockPlaced: readonly [
    // The default block data.
    readonly [ComponentTypeHeader.ByteArray, ComponentTypeHeader.Int32, ComponentTypeHeader.Int32],
    // The block data with additional arguments.
    ...(readonly [[ComponentTypeHeader.ByteArray, ComponentTypeHeader.Int32, ComponentTypeHeader.Int32, ...(typeof BlockArgs)[keyof typeof BlockArgs]]])
    // Tge implementation.
] = [...Object.keys(BlockArgs).map((args) => [ComponentTypeHeader.ByteArray, ComponentTypeHeader.Int32, ComponentTypeHeader.Int32, ...BlockArgs[args as keyof typeof BlockArgs]]), [ComponentTypeHeader.ByteArray, ComponentTypeHeader.Int32, ComponentTypeHeader.Int32]] as any;
...
export type SendEvents = {
    [K in keyof typeof SendEventsFormat]: FormatType<(typeof SendEventsFormat)[K][number]>;
};
