...
//         connection.listen("PlayerFace", (id, face) => {
//             const player = this.players.get(id);
//             if (!player) return;
...
//         connection.listen("PlayerGodMode", (id, god) => {
//             const player = this.players.get(id);
//             if (!player) return;
...
//         connection.listen("PlayerModMode", (id, mod) => {
//             const player = this.players.get(id);
//             if (!player) return;
...
//         connection.listen("PlayerRespawn", (id, x, y) => {
//             const player = this.players.get(id);
//             if (!player) return;
...
//         connection.listen("PlayerReset", (...args) => {
//             const [id] = args;
//             const player = this.players.get(id);
//             if (!player) return;
...
//         connection.listen("PlayerTouchBlock", (id, x, y, blockId) => {
//             const player = this.players.get(id);
//             if (!player) return;
